...
jlink {
    ...
    imageName = project.name + "-" + project.version + "-" + OperatingSystem.current().familyName.lowercase()
    ...
    jpackage {
        icon = if (OperatingSystem.current().isWindows) {
            "src/main/icons/sdkboy.ico"
        } else {
            "src/main/icons/sdkboy.png"
        }
