...
Developed using the `codion-swing-common-ui` module of the https://github.com/codion-is/codion[Codion Application Framework].
...
Build a zipped jlink image to `build`
...
Figured I would try to do the same using Swing, using a standard jlink image and jpackage distributions.